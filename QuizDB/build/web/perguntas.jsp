        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand page-scroll" href="index.jsp"><% %></a>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <h3><%= questionCurrent.getDescription() %></h3>
                            </h3>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <input type="radio" aria-label="..." value="<%= questionCurrent.getAlternatives().get(i).getId() %>" name="answer" checked="">
                                            </span>
                                                <input type="text" value="<%= questionCurrent.getAlternatives().get(i).getDescription() %>"  class="form-control" aria-label="...">
                                        </div><!-- /input-group -->
                                    </div><!-- /.col-lg-6 -->
                                </div><!-- /.row -->
                                <br>
